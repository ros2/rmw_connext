...
DDS_TypeCode* ConnextStaticRawData_get_typecode()
{
    ...
    static DDS_TypeCode ConnextStaticRawData_g_tc_key_hash_array =DDS_INITIALIZE_ARRAY_TYPECODE(1,(KEY_HASH_LENGTH_16), NULL,NULL);
    static DDS_TypeCode ConnextStaticRawData_g_tc_serialized_key_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
    static DDS_TypeCode ConnextStaticRawData_g_tc_serialized_data_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
    ...
    ConnextStaticRawData_g_tc_serialized_key_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_octet;

    ConnextStaticRawData_g_tc_serialized_data_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_octet;

    ConnextStaticRawData_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)& ConnextStaticRawData_g_tc_key_hash_array;
    ConnextStaticRawData_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)& ConnextStaticRawData_g_tc_serialized_key_sequence;
    ConnextStaticRawData_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)& ConnextStaticRawData_g_tc_serialized_data_sequence;
