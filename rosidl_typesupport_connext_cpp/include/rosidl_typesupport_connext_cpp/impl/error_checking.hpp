...
#ifndef ROSIDL_TYPESUPPORT_CONNEXT_CPP__IMPL__ERROR_CHECKING_HPP_
#define ROSIDL_TYPESUPPORT_CONNEXT_CPP__IMPL__ERROR_CHECKING_HPP_
...
inline const char *
check_get_default_topic_qos(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_delete_topic(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_delete_contentfilteredtopic(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_get_default_publisher_qos(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_delete_publisher(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_get_default_subscriber_qos(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_get_default_datawriter_qos(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_delete_datawriter(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_delete_subscriber(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_get_default_datareader_qos(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
inline const char *
check_delete_datareader(DDS_ReturnCode_t status)
{
  switch (status) {
    case DDS_RETCODE_OK:
      return nullptr;
...
#endif  // ROSIDL_TYPESUPPORT_CONNEXT_CPP__IMPL__ERROR_CHECKING_HPP_
