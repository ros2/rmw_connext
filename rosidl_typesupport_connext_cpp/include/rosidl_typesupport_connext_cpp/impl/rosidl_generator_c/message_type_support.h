...
// This header contains the connext specific macros used to generate the
// name of the function used to retrieve the type support for a message.

// TODO(wjwwood): move this into it's own C specific type support package

#ifndef ROSIDL_TYPESUPPORT_CONNEXT_CPP__IMPL__ROSIDL_GENERATOR_C__MESSAGE_TYPE_SUPPORT_HPP_
#define ROSIDL_TYPESUPPORT_CONNEXT_CPP__IMPL__ROSIDL_GENERATOR_C__MESSAGE_TYPE_SUPPORT_HPP_
 ...
 * expands.
 *
 * These macros also generate Connext specific symbols so they only match
 * the Connext shared library symbols.
 */
...
#define ROSIDL_GET_TYPE_SUPPORT_FUNCTION(PkgName, MsgSubfolder, MsgName) \
  rosidl_typesupport_connext_c_get_message__ ## PkgName ## __ ## MsgSubfolder ## __ ## MsgName

#define USING_ROSIDL_TYPESUPPORT_CONNEXT_C 1

#endif  // ROSIDL_TYPESUPPORT_CONNEXT_CPP__IMPL__ROSIDL_GENERATOR_C__MESSAGE_TYPE_SUPPORT_HPP_
